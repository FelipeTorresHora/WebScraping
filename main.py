...
import locale
from modelos import FundoImobiliario, Esterategia

locale.setlocale(locale.LC_ALL, 'pt_BR.UTF-8') 
def trata_porcentagem(procentagem:str):
    """
    Função para tratar o caracter de porcentagem.
    """
    return locale.aof(porcentagem.split('%')[0])

def trata_decimal(decimal:str):
...
for linha in linhas:
    ...
    fundo_imobiliario = FundoImobiliario(
        codigo, segmento, cotacao_atual, ffo_yield, p_vp,
