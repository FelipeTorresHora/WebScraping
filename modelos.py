class FundoImobiliario:
   def __init__(self, codigo, segmento, cotacao_atual:float,dividend_yield:float, ffo_yield:float, p_vp:float,
                 valor_mercado:float,liquidez:float, qt_imoveis:float, preco_m2:float,
                 aluguel_m2:float, cap_rate:float, vacancia_media:float):
       self.codigo = codigo
...
class Estrategia:
    def __init__(self, segmento="",cotacao_atual_minima=0.0,ffo_yield_minimo=0.0,dividend_yield_minimo=0.0,
                 p_vp_minimo=0.0,valor_mercado_minimo=0.0,liquidez_minima=0.0,qt_minima_imoveis=0.0,
                 valor_minimo_preco_m2=0.0,valor_minimo_aluguel_m2=0.0,valor_minimo_cap_rate=0.0,maxima_vacancia_media=0.0):
